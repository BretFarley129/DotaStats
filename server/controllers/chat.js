module.exports = {
    ...
    getChatwheelMessages: function(req, res){
        let chats = req.body;
        for (let  i = 0; i < chats.length; i ++){
            if (chats[i].type == 'chatwheel'){
                chats[i].message_val = this.chatwheels[chats[i].key].message
                if (this.chatwheels[chats[i].key].badge_tier){
                    chats[i].type = 'hero_chatwheel'
                }
                if (this.chatwheels[chats[i].key].all_chat){
                    chats[i].target = 'all'
                }
                else{
                    chats[i].target = 'team'
   ...
   chatwheels : {
     ...
     "39": {
       ...
       "name": "Buy_Courier",
       "label": "Buy courier",
       "message": "Buy a courier please"
     },
     "40": {
       "id": 40,
       "name": "Upgrade_Courier",
       "label": "Upgrade courier",
       "message": "Can anyone upgrade the courier?"
     },
     "41": {
       "id": 41,
       "name": "Need_Detection",
     ...
     "44": {
       "id": 44,
       "name": "Reuse_Courier",
       "label": "Re-use courier",
       "message": "Re-use courier"
     },
     "45": {
       "id": 45,
       "name": "Deward",
     ...
     "71": {
       ...
       "message": "[specific enemy hero] is missing!"
     },
     "72": {
       "id": 72,
       "name": "ReturnedHero",
       "label": "dota_chatwheel_label_ReturnedHero",
       "message": "[specific enemy hero] has returned!"
     },
     "73": {
       "id": 73,
       "name": "GG",
     ...
     "116": {
       "id": 116,
       "name": "Bozhe_kak_eto_bolno",
       "label": "Боже, как это больно!",
       "message": "Боже, как это больно!",
       "sound_ext": "wav"
     },
     "117": {
       "id": 117,
     ...
     "90001": {
       "id": 90001,
       "name": "keeper_of_the_light_laugh",
       "label": "Laugh",
     ...
     "90002": {
       "id": 90002,
       "name": "keeper_of_the_light_thank",
